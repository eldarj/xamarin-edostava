...
namespace Easyfood_Xamarin.Validators
{
    public static class ValidatorRules
    {
        ...
        public static string RULE_PASSWORD = @"^[a-zA-Z\d.\-#_?*]{3,}$";
        ...
        public static string MSG_PASSWORD = "*Polje password ne smije biti kraće od 3 karaktera i smije sadržati samo slova, brojeve i znakove .-#_?*";
